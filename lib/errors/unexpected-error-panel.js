...
const CATEGORY_GUIDANCE = {
  ...
  other: {
    ...
    steps: [
      ...
      'Please file a bug with the message above + your command: https://github.com/webappski/aeo-tracker/issues',
...
export function formatUnexpectedErrorPanel({ err, command, useColor = true }) {
  ...
  if (classified.category !== 'other') {
    lines.push('');
    lines.push(`${c.dim}  If none of the above help, file a bug: https://github.com/webappski/aeo-tracker/issues${c.reset}`);
  }
  lines.push('');
